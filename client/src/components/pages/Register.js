...
const navigate  = useNavigate()
  ...
  const handleSubmit=(e)=>{
      ...
      const datas = {name,email,password,role,username};
    ...
    <>
        ...
        <div class="h-screen md:flex">
            <div
                ...
                <div>
                    <h1 class="text-white font-bold text-4xl font-sans">Educa-Register</h1>
            ...
            <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
                ...
                <form onSubmit={handleSubmit} class="bg-white">
                    ...
                    <select value={role} onChange={e=>setRole(e.target.value)} name="role" id='role' class="pl-2 outline-none  border-none rounded-md text-black-800 w-full">
                    ...
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <input class="pl-2 outline-none border-none w-full" value={name} onChange={e=>setName(e.target.value)} type="text" name="name" id="name" placeholder="Full name" />
                    </div>
                    ...
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <input class="pl-2 outline-none border-none w-full" type="text" value={username} onChange={e=>setUsername(e.target.value)} name="username" id="username" placeholder="Username" />
                    </div>
                    ...
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <input class="pl-2 outline-none border-none w-full" type="text" value={email} onChange={e=>setEmail(e.target.value)} name="email" id="email" placeholder="Email Address" />
                    </div>
