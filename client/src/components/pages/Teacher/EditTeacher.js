...
const handleSubmit=(e)=>{
      ...
      fetch("http://localhost:8080/api/v1/teacher/edit/"+id,{
        method:"PUT",
    ...
    <form  onSubmit={handleSubmit}>
      ...
      <div className="flex flex-wrap px-4 py-1 w-full">
        <div className="relative w-full appearance-none label-floating">
          ...
          <input value={ids} onChange={e=>setID(e.target.value)} className="tracking-wide py-2 px-4 mb-3 leading-relaxed appearance-none block w-full bg-gray-50 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500"
